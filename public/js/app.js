...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    highlightInputField: function highlightInputField(e) {
      e.target.parentElement.classList.add('input-group-focused');
    },
    removeHighlightFromInputField: function removeHighlightFromInputField(e) {
    ...
    sendData: function sendData() {
      ...
      fetch('/login', {
        ...
        if (message.fail) {
          var _message$fail$usernam, _message$fail$passwor;

          _this.username.error = (_message$fail$usernam = message.fail.username) !== null && _message$fail$usernam !== void 0 ? _message$fail$usernam : '';
          _this.password.error = (_message$fail$passwor = message.fail.password) !== null && _message$fail$passwor !== void 0 ? _message$fail$passwor : '';
        }
    ...
    [
      _c(
        "div",
        {
          ...
          on: {
            focusin: _vm.highlightInputField,
            focusout: _vm.removeHighlightFromInputField
          }
        },
        [
          _c("input", {
            ...
            domProps: { value: _vm.username.value },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.username, "value", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
      ...
      _c("div", { staticClass: "error-block" }, [
        _vm.username.error
          ? _c("small", [_vm._v(_vm._s(_vm.username.error[0]))])
          : _vm._e()
      ]),
      _vm._v(" "),
      _c(
      ...
      _c("div", { staticClass: "error-block" }, [
        _vm.password.error
          ? _c("small", [_vm._v(_vm._s(_vm.password.error[0]))])
          : _vm._e()
      ]),
      _vm._v(" "),
      _vm._m(2)
...
module.exports = __webpack_require__(/*! D:\Projects\login-task\resources\js\app.js */"./resources/js/app.js");
